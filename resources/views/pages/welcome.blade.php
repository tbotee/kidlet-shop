...
{{--                                                <div class="main-border-button">--}}
{{--                                                    <a href="{{ route('category', ['categoryId' => 'womens']) }}">Discover More</a>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                                <p>Lorem ipsum dolor sit amet, conservisii ctetur adipiscing elit incid.</p>--}}
{{--                                                <div class="main-border-button">--}}
{{--                                                    <a href="{{ route('category', ['categoryId' => 'mens']) }}">Discover More</a>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                                <p>Lorem ipsum dolor sit amet, conservisii ctetur adipiscing elit incid.</p>--}}
{{--                                                <div class="main-border-button">--}}
{{--                                                    <a href="{{ route('category', ['categoryId' => 'kids']) }}">Discover More</a>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                                <p>Lorem ipsum dolor sit amet, conservisii ctetur adipiscing elit incid.</p>--}}
{{--                                                <div class="main-border-button">--}}
{{--                                                    <a href="{{ route('category', ['categoryId' => 'accessories']) }}">Discover More</a>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
